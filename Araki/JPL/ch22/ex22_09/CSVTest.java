...
public class CSVTest {
    ...
    public void test_readCSVTable_Benchmark() throws Exception {
        ...
        {
            StringReader in = new StringReader(
                    "123456789098,76543213456,78909876543,2111123,45678,909876,543212,34567,89098,7654321,123456789,098765432123456789098765,43213456789098767y6543212345,67890987654321,23,45678976543213456,756787654323,4567890809876,54343432,1234\n" +
                    "1234567890987,65432134567,890987654,321111234,56789,0987,65432123,456,78909,87654321,1234567890,9876543212345678909876,543213456789098767y65432123456,7890987654321,2,3456789765432134567,5678765432,345678908098765,4343432,1234\n"
            );

            long time = new CSVPatternBenchmark(csv, in, 20).repeat(count);
            System.out.println(
                    "\tlong pattern  : " + csv.createPattern(20) + 
                    "\n \t " + time + " nanoseconds");
        }
        System.out.println();
    }
