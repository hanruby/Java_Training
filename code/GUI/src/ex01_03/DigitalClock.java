...
//                (int)clockSize.getHeight() + (insets.top + insets.bottom) + (config.getMargin().top + config.getMargin().bottom));
    ...
    public void paint(Graphics g) {
        ...
        bufGraphics.drawString(config.clock(new GregorianCalendar(TimeZone.getTimeZone("Japan Standard Time, Asia/Tokyo"))), this.getInsets().left + config.getMargin().left, 
